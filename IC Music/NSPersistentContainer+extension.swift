    ...
    func copyPersistentStores(to destinationURL: URL, overwriting: Bool = true) throws -> String {
        ...
        for persistentStoreDescription in persistentStoreDescriptions {
            ...
            do {
                ...
                let enumerator = FileManager.default.enumerator(at: destinationURL,
                ...
                coordinator.coordinate(readingItemAt: destinationURL, options: [.forUploading], error: &error) { (zipUrl) in
